        ...
        private void Edition_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.ActiveMdiChild is LivreEnfantForm oEnfant)
                {
                    ...
                    if (sender == couperToolStripMenuItem || sender == couperToolStripMenuItem)
                    {
                        oRichTextBox.Cut(); // Modified = true
                    }
                    else if (sender == copierToolStripMenuItem || sender == copierToolStripMenuItem)
                    {
                        oRichTextBox.Copy();
                    }
                    else if (sender == collerToolStripMenuItem || sender == collerToolStripMenuItem)
                    {
                        oRichTextBox.Paste();
                    }
                    else if (sender ==  )
